...
export default function Index() {
    ...
    return (
      <div className="flex flex-col h-full w-full bg-bolt-elements-background-depth-1">
        ...
        <SubscriptionModal
          ...
          currentTier={(user?.publicMetadata?.subscriptionTier as any) || 'free'}
        />
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col w-full bg-black overflow-hidden">
      ...
      <main className="relative overflow-hidden h-auto lg:h-screen py-8 lg:py-0">
        {/* Spotlight Effect */}
        <Spotlight className="-top-40 left-0 md:left-60 md:-top-20" fill="white" />

        {/* Content Container */}
        <div className="flex flex-col lg:flex-row min-h-[60vh] lg:h-full w-full">
          {/* Mobile Hero Image - Shows above title on mobile */}
          <div className="lg:hidden w-full flex items-center justify-center py-4 px-4">
            <img
              src="/hero.png"
              alt="Elaric AI Hero"
              className="w-full max-w-xs h-auto object-contain rounded-lg shadow-2xl animate-float"
            />
          </div>

          {/* Left Section - Text Content */}
          <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 relative z-10 py-4 lg:py-0">
            <div className="max-w-2xl">
              <h1 className="text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400" style={{ lineHeight: '1.3' }}>
                Build with
                <br />
                Elaric Ai
              </h1>
          ...
          <div className="hidden lg:flex flex-[1.5] items-center justify-center relative">
            <div className="w-full h-full relative flex items-center justify-center">
              <img
                src="/hero.png"
                alt="Elaric AI Hero"
                className="w-full h-full object-contain rounded-lg shadow-2xl animate-float"
              />
            </div>
          </div>
        </div>
